...
func chapterTwo() {
    ...
    let randomGhostSound = GhostSound.allCases.randomElement()!
    ...
    let ghost1 = Ghost(name: "Ooooky", age: 124, sound: randomGhostSound, color: "red")
    let ghost2 = Ghost(name: "Koi Joi", age: 140, sound: .soft, color: "blue")
    let ghost3 = Ghost (name: "Pumpkin", age: 200, sound: .quiet, color: "green")
    ...
    func screaming() -> String {
        ...
        for scream in myScream {
            screamPhrases += "I was \(scream).\n"
        }
        return screamPhrases
    }
    
    func blinkingLight() -> String {
        let isLightBlinking = Bool.random()
